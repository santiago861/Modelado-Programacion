...
public class Servidor {
    ...
    public void agregaUsuario (String user){
        users.add(user);
    }
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println("Conexión establecida desde "+ users + socketCliente.getInetAddress() + ":" + socketCliente.getPort());
        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    System.out.println("Mensaje de cliente: "+ users + msjCliente);
                }
            } catch (IOException e) {
                e.printStackTrace();
            } finally {
